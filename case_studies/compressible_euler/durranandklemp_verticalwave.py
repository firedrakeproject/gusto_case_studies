...
mountain_nonhydrostatic_defaults = {
    ...
    'tmax': 30000.,
    'dumpfreq': 300,
    'dirname': 'durranandklemp_verticalwave_30000',
    'hydrostatic': False
}
...
def mountain_nonhydrostatic(
    ...
    domain_height = 16000.   # height of model top, in m
    ...
    sponge_depth = 8000.0   # depth of sponge layer, in m
