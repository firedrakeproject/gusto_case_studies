...
mountain_nonhydrostatic_defaults = {
    ...
    'tmax': 30000,
    'dumpfreq': 50,
    'dirname': 'moist_trapped_wave_1initialisation',
    'hydrostatic': False
}
...
def mountain_nonhydrostatic(
    ...
    domain_width = 160000.   # width of domain in x direction, in m
    domain_height = 15984.   # height of model top, in m
    a = 2500.                # scale width of mountain, in m
    hm = 10.                  # height of mountain, in m
    ...
    # Relative humidity
    relhum = conditional(z<z1, 1, 0)
    relhum_cond = Function(Vt).interpolate(relhum)
    ...
    unsaturated_hydrostatic_balance(
        eqns, stepper.fields, theta_b, relhum_cond, exner_dry, top=False, exner_boundary=bottom_boundary
    )
