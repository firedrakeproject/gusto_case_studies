"""
Plots the thermal Williamson 5 test case.
"""
...
results_file_name = f'{abspath(dirname(__file__))}/../../results/thermal_williamson_5/field_output.nc'
plot_stem = f'{abspath(dirname(__file__))}/../../figures/thermal_shallow_water/thermal_williamson_5'
...
init_contours = [np.linspace(0.0, 20.0, 9),
                 np.linspace(3600.0, 6000.0, 13),
                 np.linspace(-1e-5, 1e-5, 11),
...
final_contours = [np.linspace(-4e-5, 4e-5, 17),
                  np.linspace(8.8, 11.2, 13)]
