"""
Plots the hydrostatic Skamarock-Klemp gravity wave in a vertical slice.
...
final_contours = np.linspace(-3.5e-3, 3.5e-3, 15)
...
cf, lines = plot_contoured_field(
    ax, coords_X, coords_Z, field_data, contour_method, final_contours,
    cmap=cmap, line_contours=lines
)
